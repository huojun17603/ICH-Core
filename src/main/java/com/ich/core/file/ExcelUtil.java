...
//            Map<String,Object> mol = new LinkedHashMap<String,Object>();
//            mol.put("name","POI"+i);
//            mol.put("age",i);
//            mol.put("birthday",new Date());
//            mol.put("height",i);
//            mol.put("weight",i);
//            mol.put("sex",i/2==0?false:true);
//            list.add(mol);
//        }
...
//
//        String title = "测试";
//        OutputStream outXlsx = new FileOutputStream("E://b1.xlsx");
//        System.out.println("正在导出xlsx....");
//        Date d2 = new Date();
//        ExcelUtil.exportExcelX(title,headMap,list,DEFAULT_DATE_PATTERN,DEFAULT_COLOUMN_WIDTH,outXlsx);
