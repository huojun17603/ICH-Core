...
public class HttpClientNUtil {

    private final static Logger LOGGER = LoggerFactory.getLogger(HttpClientNUtil.class);
    ...
    public static String post(String urlToRequest , Map<String, Object> parameters , Integer connectionRequestTimeout ,
        ...
        try {
            LOGGER.info("post-req:url:{},param:{}", urlToRequest, JsonUtils.objectToJson(parameters));
